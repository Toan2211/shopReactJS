...
const FILTER_LIST = [
    ...
    {
        id: 3,
        getLabel:(filters, categoryList) => `Từ ${filters.salePrice_gte} đến ${filters.salePrice_lte}`,
        isActive: () => true,
    ...
    },
    {
        ...
        getLabel:(filters, categoryList) => {
            ...
            const category = categoryList.find(x => x.id === Number.parseInt(filters['category.id']))
...
function FilterViewer({filters = {}, onChange = null}) {
    ...
    return (
        <Box component = "ul" sx = {{display: 'flex', flexflow: 'row wrap', alignItems: 'center', margin: '10px 0', listStyleType: 'none'}}>
